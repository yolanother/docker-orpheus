...
def text_to_speech(text, voice, temperature=0.4, repetition_penalty=1.1):
...
def create_interface():
    ...
    with gr.Blocks(title="Orpheus TTS") as demo:
        ...
        generate_button.click(
            fn=text_to_speech,
            inputs=[text_input, voice_dropdown, temperature_slider, repetition_penalty_slider],
        ...
        gr.Examples(
            examples=[
                ["Hello, my name is Tara. How are you doing today?", "tara"],
                ["I'm excited to demonstrate the capabilities of Orpheus TTS!", "leah"],
                ["This is an example of the Orpheus text-to-speech system.", "leo"]
            ],
